...
const ITEMS = [
  ...
  { key: 'courts',       label: 'Корты',    sublabel: 'на карте',     icon: '/icons/icon-location.svg',  color: 'text-emerald-400',bg: 'bg-emerald-400/10'},
  { key: 'gamesThisWeek',label: 'Игры',     sublabel: 'на этой неделе', icon: '/icons/icon-games.svg',   color: 'text-primary',    bg: 'bg-primary/10'    },
  { key: 'news',         label: 'Статьи',   sublabel: 'опубликовано', icon: '/icons/icon-news.svg',      color: 'text-violet-400', bg: 'bg-violet-400/10' },
] as const;

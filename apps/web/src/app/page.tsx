    ...
    <>
      ...
      <section className="relative overflow-hidden min-h-screen flex items-center">
        ...
        <div className="container-page relative z-10 w-full">
          <div className="flex flex-col items-center text-center py-24 md:py-32 gap-8">
            {/* Заголовок */}
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              <h2 className="font-display font-bold text-2xl md:text-3xl">
                Ближайшие <span className="text-primary">Pickup Games</span>
              </h2>
              <p className="text-muted-foreground text-sm mt-1">
                Присоединяйся к играм в ближайшие дни
              </p>
            </div>
            <Link
              href="/pickup-games"
        ...
        <div className="container-page">
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-muted-foreground text-sm mt-1">
                Баскетбол Узбекистана в деталях
              </p>
            </div>
            <Link
              href="/news"
        ...
        <div className="container-page">
          <div className="text-center mb-10">
            ...
            <p className="text-muted-foreground text-sm">
              Контент каждый день — подписывайся на наши каналы
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-3xl mx-auto">
            ...
            >
              ...
              <div className="text-center">
                <div className="font-display font-bold text-base">YouTube</div>
                <div className="text-xs text-muted-foreground mt-1">@ubculture</div>
              </div>
            </a>
            ...
            >
              ...
              <div className="text-center">
                <div className="font-display font-bold text-base">Instagram</div>
                <div className="text-xs text-muted-foreground mt-1">@ubcbasketbal</div>
              </div>
            </a>
          </div>
        </div>

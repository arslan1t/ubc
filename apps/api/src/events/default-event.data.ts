...
export const DEFAULT_TOURNAMENT: Prisma.EventCreateInput = {
  slug: '1v1-july-4',
  ...
  sponsors: [],
  faq: [
    { question: 'Кто может участвовать?', answer: 'Любой зарегистрированный пользователь платформы UBC.' },
    { question: 'Нужно ли платить за участие?', answer: 'Нет, участие бесплатное.' },
    { question: 'Что взять с собой?', answer: 'Спортивную форму, кроссовки и хорошее настроение.' },
  ],
  maxParticipants: 32,
};
